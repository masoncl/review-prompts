...
## Common stateid types and their reference patterns
...
- Additional: dl_recalled list management
...
- Stateid generation must increment on OPEN_DOWNGRADE/LOCK
...
- [ ] Stateid generation incremented when required by RFC
...
**If any checklist items are incomplete, go back and start over
from Phase 1.**
