...
For each pointer dereference, create a TodoWrite entry with:
- Pointer name: [name]
- Dereferenced at: [function:description]
  - Remember foo->ptr dereferences foo BUT NOT ptr
- Explicit NULL check needed: [YES/NO + why]
...
- track in TodoWrite uninitialized variables into tracked functions and verify they initialize before use
  - writing to a variable counts as initializing it
...
**Pattern-specific questions**:
  ...
  8. How many pointer dereferences did you find? [number]
  9. foo->ptr dereferences foo BUT NOT ptr
